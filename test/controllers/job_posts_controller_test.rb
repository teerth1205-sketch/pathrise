...
class JobPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_post" do
    assert_difference("JobPost.count") do
      post job_posts_url, params: { job_post: { companyName: @job_post.companyName, id: @job_post.id, title: @job_post.title, url: @job_post.url } }
    end
  ...
  test "should update job_post" do
    patch job_post_url(@job_post), params: { job_post: { companyName: @job_post.companyName, id: @job_post.id, title: @job_post.title, url: @job_post.url } }
